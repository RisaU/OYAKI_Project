...
require_once "dbCon.php";
    ...
    $display_block = "<h2>Item Detail</h2>";
...
END_OF_TEXT;
        ...
        $display_block .= "<p><strong><label for=\"sel_item_qty\">Select Quantity:</strong><label>
        ...
        $display_block .= <<<END_OF_TEXT
            ...
            <button class="basicBtn2" type="submit" name="submit" value="submit">Add to Cart</button>
            <a href="checkout.php" class="basicBtn2">Checkout</a>
            </form>
            </div>
            </div> <!-- showItem -->
        </div> <!-- wrapper -->
